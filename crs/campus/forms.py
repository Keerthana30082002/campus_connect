...
class UsdForm(forms.Form):
    ...
    phone_number = forms.CharField(
        max_length=10, min_length=10, initial="enter ur phn num", required=True
    )


class ccdForm(forms.Form):
    hr_name = forms.CharField(max_length=30, required=True, help_text="*required")
    hr_phn = forms.CharField(
        max_length=10, min_length=10, required=True, help_text="*required"
    )
...
c_type = (("product", "product"), ("service", "service"))
